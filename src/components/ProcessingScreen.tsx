...
const steps = [
  { label: "Vérification des détails de paiement", icon: CreditCard },
  { label: "Sécurisation de la transaction", icon: Shield },
    ...
    <div className="flex flex-col items-center justify-center py-16 space-y-8">
      ...
      <div className="text-center">
        <h2 className="font-display text-2xl font-bold text-foreground mb-2">
          {currentStep < 3 ? "Traitement de votre don" : "Don effectué !"}
        </h2>
      ...
      <p className="text-xs text-muted-foreground">🔒 Transaction simulée sécurisée</p>
    </div>
  );
};
